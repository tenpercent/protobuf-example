...
cpp: timetable.proto
	protoc -I=. --cpp_out=. timetable.proto
	
java: timetable.proto
	protoc -I=. --java_out=. ./timetable.proto
			
writer: add_timetable_entry.cc
	c++ -Wall add_timetable_entry.cc timetable.pb.cc -I/Users/tenpercent/local/include -L/Users/tenpercent/local/lib -lprotobuf -std=c++11 -o add_entry.exe
